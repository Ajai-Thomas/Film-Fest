    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-white/20 pb-6 mb-16">
          <div>
            <span className="block text-accent text-xs md:text-sm tracking-[0.4em] font-bold mb-2 uppercase drop-shadow-md">
              Official Selection
            </span>
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-ostwall text-white uppercase leading-[0.9] drop-shadow-lg">
              Featured <br /> 
